package scratch.spring.persistence.test.data;
...
import static scratch.spring.persistence.test.data.DBUnits.ADDRESS;
import static scratch.spring.persistence.test.data.DBUnits.ADDRESS_ID;
import static scratch.spring.persistence.test.data.DBUnits.ID;
import static scratch.spring.persistence.test.data.DBUnits.USER;
import static scratch.spring.persistence.test.data.DBUnits.addressTable;
import static scratch.spring.persistence.test.data.DBUnits.columnValue;
import static scratch.spring.persistence.test.data.DBUnits.mapAddress;
import static scratch.spring.persistence.test.data.DBUnits.mapUser;
import static scratch.spring.persistence.test.data.DBUnits.userTable;
import static scratch.spring.persistence.test.data.DBUnits.wrapCheckedException;
